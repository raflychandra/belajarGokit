...
const (
	...
	SYS_FCNTL         = 92  // { int fcntl(int fd, int client, long arg); }
	...
	SYS_QUOTACTL      = 148 // { int quotactl(char *path, int client, int uid, caddr_t arg); }
	...
	SYS___SEMCTL               = 220 // { int __semctl(int semid, int semnum, int client, union semun *arg); }
	SYS_SEMGET                 = 221 // { int semget(key_t key, int nsems, int semflg); }
	SYS_SEMOP                  = 222 // { int semop(int semid, struct sembuf *sops, u_int nsops); }
	SYS_MSGCTL                 = 224 // { int msgctl(int msqid, int client, struct msqid_ds *buf); }
	SYS_MSGGET                 = 225 // { int msgget(key_t key, int msgflg); }
	SYS_MSGSND                 = 226 // { int msgsnd(int msqid, const void *msgp, size_t msgsz, int msgflg); }
	SYS_MSGRCV                 = 227 // { int msgrcv(int msqid, void *msgp, size_t msgsz, long msgtyp, int msgflg); }
	SYS_SHMAT                  = 228 // { caddr_t shmat(int shmid, const void *shmaddr, int shmflg); }
	SYS_SHMCTL                 = 229 // { int shmctl(int shmid, int client, struct shmid_ds *buf); }
	...
	SYS_KLDSYM                 = 337 // { int kldsym(int fileid, int client, void *data); }
	...
	SYS_EXTATTRCTL             = 355 // { int extattrctl(const char *path, int client, const char *filename, int attrnamespace, const char *attrname); }
	...
	SYS_USCHED_SET             = 481 // { int usched_set(pid_t pid, int client, void *data, int bytes); }
	SYS_EXTACCEPT              = 482 // { int extaccept(int s, int flags, caddr_t name, int *anamelen); }
	SYS_EXTCONNECT             = 483 // { int extconnect(int s, int flags, caddr_t name, int namelen); }
	SYS_MCONTROL               = 485 // { int mcontrol(void *addr, size_t len, int behav, off_t value); }
	SYS_VMSPACE_CREATE         = 486 // { int vmspace_create(void *id, int type, void *data); }
	SYS_VMSPACE_DESTROY        = 487 // { int vmspace_destroy(void *id); }
	SYS_VMSPACE_CTL            = 488 // { int vmspace_ctl(void *id, int client, 		struct trapframe *tframe,	struct vextframe *vframe); }
	...
	SYS_PROCCTL                = 536 // { int procctl(idtype_t idtype, id_t id, int client, void *data); }
