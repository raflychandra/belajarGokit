...
const (
	...
	SYS_AUDITON                  = 446 // { int auditon(int client, void *data, u_int length); }
	...
	SYS___SEMCTL                 = 510 // { int __semctl(int semid, int semnum, int client, union semun *arg); }
	SYS_MSGCTL                   = 511 // { int msgctl(int msqid, int client, struct msqid_ds *buf); }
	SYS_SHMCTL                   = 512 // { int shmctl(int shmid, int client, struct shmid_ds *buf); }
